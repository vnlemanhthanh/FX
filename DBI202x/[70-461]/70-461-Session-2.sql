...
select tblEmployee.EmployeeNumber,sum(Amount) as SumOfAmount, EmployeeFirstName, EmployeeLastName
from tblEmployee right join tblTransaction
...
select D.Department, Sum(T.Amount) as SumOfAmount
