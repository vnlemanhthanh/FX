...
select * from tblTransaction -- 2486 rows 2500
--intersect
--except
--union
--union all
select * from tblTransactionNew -- 1657 rows 1666, 829 changed rows 833, 828 unchanged 1667
...
select case when left(EmployeeGovermentID,1)='A' then 'Letter A'
